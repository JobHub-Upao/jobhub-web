...
import { RegistroEmpleadorComponent } from './empleador/registro-empleador/registro-empleador.component';
...
const routes: Routes = [
  ...
  {path:'empleador/registrar',component:RegistroEmpleadorComponent}
];
